...
[![My Skills](https://skillicons.dev/icons?i=html,css,tailwind,threejs,javascript,typescript,redux,react,next,kotlin,git,kali,debian,ubuntu,linux,postman,firebase,npm,vim,neovim,sass,vercel,docker,cloudflare,nodejs,express,nestjs,graphql,mysql,mongodb,postgres)](https://skillicons.dev)
